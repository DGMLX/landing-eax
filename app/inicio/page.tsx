                ...
                <div className="flex-col md:flex-row  lg:flex-row flex gap-5 mb-7 ">
                    <div className="bg-gray-300 w-full sm:w-full md:w-1/2 h-[350px] flex flex-col justify-center" style={{
                        ...
                        <div className="flex flex-col px-5 lg:px-10 text-white">
                            ...
                            <Link href="https://ecoalliance.cl/blog/" className=" flex items-center text-xl border border-[#C4262E] px-4 py-3 rounded-full bg-[#C4262E] text-white hover:bg-[#B01C1C] hover:text-white hover:underline">DESCUBRE MÁS<HiArrowLongRight className="ml-5 text-3xl"/></Link>
                            </div>
                        </div>
                    </div>
