        ...
        <main className="mt-[80px] lg:mt-[130px] xl:mt-[135px] animate-fade animate-duration-[1000ms] animate-normal animate-fill-both">
            ...
            <section className="mx-5 md:mx-20 mb-5  animate-duration-700 animate-fade-left">
                ...
                <div className="flex justify-between gap-5 flex-col md:flex-row ">  
                    ...
                    <div className="md:w-1/2 lg:w-1/3 hover:shadow-xl">
                        ...
                        <div className="px-6 pt-5 border-gray-300 border  flex flex-col justify-between 2xl:justify-around md:h-[550px] lg:h-[550px] xl:h-[420px] 2xl:h-[370px]" >
                            ...
                            <div className="my-5 flex justify-end items-center text-[#c4262e] xl:mr-10">
                                <Link href="https://ecoalliance.cl/camion-multiproposito/" className="text-xl mr-5">DESCUBRE MÁS</Link>
                    ...
                    <div className="md:w-1/2 lg:w-1/3 hover:shadow-xl">
                        ...
                        <div className="px-6 pt-5  border-gray-300 border flex flex-col justify-between 2xl:justify-around md:h-[550px] lg:h-[550px] xl:h-[420px] 2xl:h-[370px]">
                            ...
                            <div className="my-5 flex justify-end items-center text-[#c4262e] xl:mr-10">
                                <Link href="https://ecoalliance.cl/soluciones-tratamiento-de-residuos/" className="text-xl mr-5">DESCUBRE MÁS</Link>
                                <HiArrowLongRight className="text-4xl"/>
                            </div>
                        </div>
                    </div>
                    <div className=" lg:w-1/3 sm:hidden lg:block hover:shadow-xl">
                        ...
                        <div className="px-6 pt-5  border-gray-300 border flex flex-col justify-between 2xl:justify-around md:h-[550px] lg:h-[550px] xl:h-[420px] 2xl:h-[370px]">
                            ...
                            <div className="my-5 flex justify-end items-center text-[#c4262e] xl:mr-10">
                                <Link href="https://ecoalliance.cl/espacios-publicos/" className="text-xl mr-5">DESCUBRE MÁS</Link>
                                <HiArrowLongRight className="text-4xl"/>
                            </div>
                        </div>
                    </div>
            ...
            <section className="mx-5 md:mx-20 mb-10">
                ...
                <div className="lg:w-1/3 hover:shadow-xl md:w-1/2 border">
                        ...
                        <div className="px-6 pt-5  border-t flex flex-col justify-between 2xl:justify-around md:h-[550px] lg:h-[570px] xl:h-[420px] 2xl:h-[370px]">
                            ...
                            <div className="my-5 flex justify-end items-center text-[#c4262e] xl:mr-10">
                                <Link href="https://ecoalliance.cl/soluciones-aseo-urbano/" className="text-xl mr-5">DESCUBRE MÁS</Link>
                                <HiArrowLongRight className="text-4xl"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-1/3 hover:shadow-xl md:w-1/2 border">
                        ...
                        <div className="px-6 pt-5  border-t flex flex-col justify-between 2xl:justify-around md:h-[550px] lg:h-[570px] xl:h-[420px] 2xl:h-[370px]">
                            ...
                            <div className="my-5 flex justify-end items-center text-[#c4262e] xl:mr-10">
                                <Link href="https://ecoalliance.cl/soluciones-mantenimiento-urbano/" className="text-xl mr-5">DESCUBRE MÁS</Link>
                                <HiArrowLongRight className="text-4xl"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-1/3 sm:hidden lg:block hover:shadow-xl border ">
                        ...
                        <div className="px-6 pt-5 border-t  flex flex-col justify-between 2xl:justify-around md:h-[550px] lg:h-[570px] xl:h-[420px] 2xl:h-[370px]">
                            ...
                            <div className="my-5 flex justify-end items-center text-[#c4262e] xl:mr-10">
                                <button className="text-xl mr-5">DESCUBRE MÁS</button>
                                <HiArrowLongRight className="text-4xl"/>
                            </div>
                        </div>
                    </div>
            ...
            <div className="lg:w-1/3 md:w-1/2 hover:shadow-xl hidden sm:block lg:hidden">
                        ...
                        <div className="px-6 pt-5  border-gray-300 border  flex flex-col justify-around md:h-[550px]">
                ...
                <div className="flex flex-wrap justify-between w-full">
                    ...
                    <div className="w-full lg:w-[49%] xl:w-[24%] hover:shadow-xl flex flex-col border">
                        ...
                        <div className="px-6 pt-5 h-[410px] sm:h-[300px] lg:h-[380px] xl:h-[550px] 2xl:h-[460px] w-full flex flex-col justify-between ">
                            ...
                            <div className="mt-9 mb-9 flex justify-end items-center text-[#c4262e] xl:mr-10">
                                <Link href="https://ecoalliance.cl/camion-multicar-m31-c/" className="text-xl mr-5">DESCUBRE MÁS</Link>
                                <HiArrowLongRight className="text-4xl"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full lg:w-[49%] xl:w-[24%]  hover:shadow-xl border  flex flex-col mt-5 xl:mt-0">
                        ...
                        <div className="px-6 pt-5 h-[450px] sm:h-[300px] lg:h-[380px] xl:h-[550px] 2xl:h-[460px] flex flex-col justify-between ">
                            ...
                            <div className="mt-9 mb-9 flex justify-end items-center text-[#c4262e] xl:mr-10">
                                <Link href="https://landing-eax.vercel.app/eliet/trituradoras-remolcables-de-carretera/super-prof-max-on-road" className="text-xl mr-5">DESCUBRE MÁS</Link>
                                <HiArrowLongRight className="text-4xl"/>
                            </div>
                        </div>
                    </div>
            ...
            <section className="md:mx-20  md:mb-20 mx-5 md-5">
                ...
                <div className="flex-col md:flex-row  lg:flex-row flex gap-5 mb-7 ">
                    <div className="bg-gray-300 w-full sm:w-full md:w-1/2 h-[350px] flex flex-col justify-center" style={{
                        backgroundImage:'url(/inicio/blog.png)',
                        ...
                        <div className="flex flex-col px-5 lg:px-10 text-white">
                            
                            <h3 className="mb-5 text-lg underline underline-offset-[12px]">BLOG</h3>
                            ...
                            <Link href="https://ecoalliance.cl/blog/" className=" flex items-center text-[18px] border border-[#C4262E] px-4 py-2 rounded-full bg-[#C4262E] text-white hover:bg-[#B01C1C] hover:text-white hover:underline">DESCUBRE MÁS<HiArrowLongRight className="ml-5 text-3xl"/></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-300 w-full sm:w-full md:w-1/2 h-[350px] flex flex-col justify-center" style={{
                        ...
                        <div className="flex flex-col px-5 lg:px-10 text-white">
                            ...
                            <h3 className="mb-5 text-lg underline underline-offset-[12px]">SERVICIOS </h3>
                            ...
                            <Link href="https://ecoalliance.cl/servicios/" className=" flex items-center text-[18px] border border-[#C4262E]  py-2 px-4 rounded-full bg-[#C4262E] text-white hover:bg-[#B01C1C] hover:text-white hover:underline">DESCUBRE MÁS<HiArrowLongRight className="ml-5 text-3xl"/></Link>
