            ...
            <section className="mb-20">
                    <div className="block md:flex ">
                        ...
                        <div className="w-screen md:w-1/2 bg-[#F6F6F6] ">
                            <p className="text-end pr-10 text-2xl font-bold pt-5 pb-3 md:pb-0 md:pr-10 md:pt-3 lg:pr-32 lg:pt-10 xl:pt-20">01</p>
                    ...
                    <div className="block md:hidden ">
                        ...
                        <div className="w-screen md:w-1/2 bg-[#F6F6F6] ">
                            <p className="text-end pr-10 text-2xl font-bold pt-5  pb-3">02</p>
                            <div className=" ">
                    ...
                    <div className="block md:flex">
                        ...
                        <div className="w-screen md:w-1/2 bg-[#F6F6F6]">
                            <p className="text-end pr-10 text-2xl font-bold pt-5 pb-3 md:pb-0 md:pr-10 md:pt-3 lg:pr-32 lg:pt-10 xl:pt-20">03</p>
                            <div className="md:pl-10 md:pr-4 lg:pl-24 lg:pr-20 lg:pt-10 xl:pr-52 xl:pt-40">
                        ...
                        <div className="w-screen md:w-1/2 bg-[#F6F6F6] ">
                            <p className="text-end pr-10 text-2xl font-bold pt-5 pb-3">04</p>
                            <div className=" ">
                    ...
                    <div className="block md:flex">
                        ...
                        <div className="w-screen md:w-1/2 bg-[#F6F6F6]">
                            <p className="text-end pr-10 text-2xl font-bold pt-5 pb-3 md:pb-0 md:pr-10 md:pt-3 lg:pr-32 lg:pt-10 xl:pt-20">05</p>
                            <div className="md:pl-10 md:pr-4 lg:pl-24 lg:pr-20 lg:pt-10 xl:pr-52 xl:pt-40">
                        ...
                        <div className="w-screen md:w-1/2 bg-[#F6F6F6] ">
                            <p className="text-end pr-10 text-2xl font-bold pt-5 pb-3">06</p>
                            <div className=" ">
