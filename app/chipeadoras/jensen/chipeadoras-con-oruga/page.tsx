...
export const metadata: Metadata = {
  title: 'Chipeadoras con oruga - EcoAlliance',
  description: '',
}

const Productos = data;

const productosFiltrados = Productos.filter(producto=>producto.categoria==="chipeadoras con oruga")
                ...
                <div className="bg-[#F4F4F4]">
                    ...
                    <section  className="px-10 mt-10">
                        <div className="flex justify-between">
                            ...
                            <h1 className="text-3xl">Chipeadoras con Oruga</h1>
