...
const SubNavegacionProductos:React.FC<Props> = ({setHoverSubProductos,hoverSubProductos}) =>{
    ...
    return(
        <div className={` text-white md:ml-10 lg:ml-36 xl:ml-52 mr-96 ${hoverSubProductos ? 'flex' : 'hidden'}`} onMouseLeave={()=>outHover()} >
              <div className="z-30 bg-[#1E1E1E] px-10 absolute flex justify-around pt-10 pb-10">
                ...
                <div>
                  ...
                  <div className="flex items-center mt-4 mb-3">
                    ...
                    <Link href={"/productos/tratamiento-de-residuos/chipeadoras"} onClick={()=>setHoverSubProductos(false)}>Chipeadoras</Link>
                  </div>
                  <div className="flex items-center  mt-3 mb-5">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <Image src="/navProductos/basureros_urbanos.png" alt="Producto basureros urbanos" width={30} height={30} className="mr-11" />
