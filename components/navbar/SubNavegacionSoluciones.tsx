        ...
        <>
          ...
          <div className={` text-white md:ml-10 lg:ml-[310px]  xl:ml-[368px] mr-96 ${hoverSubSoluciones ? 'flex' : 'hidden'}`} onMouseLeave={()=>outHover()} >
              <div className="z-30 bg-[#1E1E1E] fixed top-[63px] ">
                ...
                <div className="flex" >
                  <div className="bg-[#1E1E1E] w-[15px]" onMouseEnter={()=>hoverBonus()}></div> 
                ...
                <a href="https://ecoalliance.cl/espacios-publicos/" className="text-white text-xs py-4 flex border-b border-slate-600 pl-[55px] pr-5"  onMouseEnter={()=>hoverNav()}>ESPACIOS PÚBLICOS</a>
              </div>
          </div>
