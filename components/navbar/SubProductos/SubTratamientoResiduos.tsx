        ...
        <>
            <div className={` text-white md:ml-10 lg:ml-[436px] xl:ml-[499px]   mr-96 ${hoverTratamientoResiduos ? 'flex' : 'hidden'}`} onMouseLeave={()=>outHover()}>
                <div className="z-30  bg-[#1E1E1E] fixed top-[114px] ">
                    ...
                    <a href="https://ecoalliance.cl/briquetadoras/" className="text-white text-xs pt-4 pb-[17.5px] flex border-b border-slate-600 pl-10 pr-5 ">BRIQUETADORAS</a>
                    <a href="https://ecoalliance.cl/trituradoras/" className="text-white text-xs pt-4 pb-[18.5px] flex border-b border-slate-600 pl-10 pr-5 ">TRITURADORAS</a>
                    <a href="https://ecoalliance.cl/cribas/" className="text-white text-xs pt-4 pb-[17.5px] flex border-b border-slate-600 pl-10 pr-5 ">CRIBAS</a>
                    <a href="https://ecoalliance.cl/compost/" className="text-white text-xs pt-4 pb-[17.5px] flex border-b border-slate-600 pl-10 pr-5 ">COMPOST</a>
                </div>
            </div>
