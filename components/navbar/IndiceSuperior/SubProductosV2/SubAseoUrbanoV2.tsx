...
const SubAseoUrbanoV2:React.FC<Props>= ({hoverAseoUrbano,setHoverAseoUrbano,setHoverSubProductos,isVisible}) =>{
    ...
    return(
        <>
            <div className={` text-white md:ml-10 lg:ml-[436px] xl:ml-[515px] mr-96 ${hoverAseoUrbano ? 'flex' : 'hidden'}`} onMouseLeave={()=>outHover()}>
                <div className={`z-50  bg-[#1E1E1E] fixed ${isVisible ? 'top-[222px]' : 'top-[165px]'}`}>
