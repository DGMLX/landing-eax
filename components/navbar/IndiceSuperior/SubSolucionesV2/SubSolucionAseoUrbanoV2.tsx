...
const SubSolucionAseoUrbanoV2:React.FC<Props> = ({hoverSolucionAseo,setHoverSolucionAseo,setHoverSubSoluciones,isVisible}) =>{
    ...
    return(
        ...
        <div className={` text-white md:ml-10 lg:ml-[556px] xl:ml-[629px] mr-96 ${hoverSolucionAseo ? 'flex' : 'hidden'}`} onMouseLeave={()=>outHover()}>
            <div className={`z-50  bg-[#1E1E1E] fixed ${isVisible ? 'top-[217px]' : 'top-[160px]'}`}>
