...
const SubSolucionMantenimientoV2:React.FC<Props> = ({hoverSolucionMantenimiento,setHoverSolucionMantenimiento,setHoverSubSoluciones}) =>{
    ...
    return(
        ...
        <div className={` text-white md:ml-10 lg:ml-[556px] xl:ml-[629px] mr-96 ${hoverSolucionMantenimiento ? 'flex' : 'hidden'}`} onMouseLeave={()=>outHover()}>
            <div className="z-50  bg-[#1E1E1E] fixed top-[269px]">
